  ...
  footer.innerHTML = `
    <div class="container footer-grid">
      ...
      <div class="small">
        ...
        <div style="margin-top:6px"><a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener" style="color:inherit;text-decoration:none">沪ICP备2026008040号-2</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="https://beian.mps.gov.cn/#/query/webSearch?code=37091102000921" rel="noreferrer" target="_blank" style="color:inherit;text-decoration:none">鲁公网安备37091102000921号</a></div>
      </div>
    </div>`;
}
        ...
        <div class="user-dropdown" data-user-dropdown role="menu" aria-label="用户菜单">
          <div class="ud-scroll">
            ...
            ${(membership && membership !== 'none')
              ? `<a role="menuitem" href="videos.html?source=glomcon" style="color:#c084fc">✓ GlomCon 教育会员</a>`
              : `<a role="menuitem" href="checkout.html?product=MEMBERSHIP-YEARLY" style="color:#fbbf24">👑 开通 GlomCon 教育会员</a>`}
