-- ============================================================
-- Migration: Ensure contact columns exist on orders table
-- Fixes: "column contact_wechat does not exist" error
-- Safe to re-run (idempotent).
-- ============================================================

-- Add contact columns if they don't already exist
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS contact_wechat text;
...
-- Recreate the submit_order_for_review function to ensure it matches
